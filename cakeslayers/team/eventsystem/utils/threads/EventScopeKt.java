...
public final class EventScopeKt
{
    @NotNull
    ...
    static {
        ...
        pool0 = new ThreadPoolExecutor(cpuCount * 2, maxSize, 5L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), (ThreadFactory)new CountingThreadFactory("Troll Hack Pool"));
        context0 = ExecutorsKt.from((ExecutorService)EventScopeKt.pool0);
    }
}
