...
public class RenderUtil implements Util
{
    ...
    public static void drawBoundingBoxWithSides(final AxisAlignedBB axisAlignedBB, final int width, final GSColor color, final int alpha, final int sides) {
        ...
        doVerticies(axisAlignedBB, (Color)color, alpha, bufferbuilder, sides, true);
        tessellator.draw();
    }
    ...
    public static void drawBoundingBoxTest(final AxisAlignedBB aa) {
        final Tessellator tessellator = Tessellator.getInstance();
    ...
    public static void drawBoundingBox(final AxisAlignedBB bb, final double width, final GSColor color, final int alpha) {
        ...
        color.glColor();
        bufferbuilder.begin(3, DefaultVertexFormats.POSITION_COLOR);
        colorVertex(bb.minX, bb.minY, bb.minZ, (Color)color, color.getAlpha(), bufferbuilder);
        colorVertex(bb.minX, bb.minY, bb.maxZ, (Color)color, color.getAlpha(), bufferbuilder);
        colorVertex(bb.maxX, bb.minY, bb.maxZ, (Color)color, color.getAlpha(), bufferbuilder);
        colorVertex(bb.maxX, bb.minY, bb.minZ, (Color)color, color.getAlpha(), bufferbuilder);
        colorVertex(bb.minX, bb.minY, bb.minZ, (Color)color, color.getAlpha(), bufferbuilder);
        colorVertex(bb.minX, bb.maxY, bb.minZ, (Color)color, alpha, bufferbuilder);
        colorVertex(bb.minX, bb.maxY, bb.maxZ, (Color)color, alpha, bufferbuilder);
        colorVertex(bb.minX, bb.minY, bb.maxZ, (Color)color, color.getAlpha(), bufferbuilder);
        colorVertex(bb.maxX, bb.minY, bb.maxZ, (Color)color, color.getAlpha(), bufferbuilder);
        colorVertex(bb.maxX, bb.maxY, bb.maxZ, (Color)color, alpha, bufferbuilder);
        colorVertex(bb.minX, bb.maxY, bb.maxZ, (Color)color, alpha, bufferbuilder);
        colorVertex(bb.maxX, bb.maxY, bb.maxZ, (Color)color, alpha, bufferbuilder);
        colorVertex(bb.maxX, bb.maxY, bb.minZ, (Color)color, alpha, bufferbuilder);
        colorVertex(bb.maxX, bb.minY, bb.minZ, (Color)color, color.getAlpha(), bufferbuilder);
        colorVertex(bb.maxX, bb.maxY, bb.minZ, (Color)color, alpha, bufferbuilder);
        colorVertex(bb.minX, bb.maxY, bb.minZ, (Color)color, alpha, bufferbuilder);
        tessellator.draw();
    ...
    public static void drawBox(final double x, final double y, final double z, final double w, final double h, final double d, final GSColor color, final int alpha, final int sides) {
        ...
        color.glColor();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_COLOR);
        doVerticies(new AxisAlignedBB(x, y, z, x + w, y + h, z + d), (Color)color, alpha, bufferbuilder, sides, false);
        tessellator.draw();
        GlStateManager.enableAlpha();
    }
    ...
    public static void drawBox(final Vec3d pos, final Color color) {
        final AxisAlignedBB bb = new AxisAlignedBB(pos.x - RenderUtil.mc.getRenderManager().viewerPosX, pos.y - RenderUtil.mc.getRenderManager().viewerPosY, pos.z - RenderUtil.mc.getRenderManager().viewerPosZ, pos.x + 1.0 - RenderUtil.mc.getRenderManager().viewerPosX, pos.y + 1.0 - RenderUtil.mc.getRenderManager().viewerPosY, pos.z + 1.0 - RenderUtil.mc.getRenderManager().viewerPosZ);
        RenderUtil.camera.setPosition(Objects.requireNonNull(RenderUtil.mc.getRenderViewEntity()).posX, RenderUtil.mc.getRenderViewEntity().posY, RenderUtil.mc.getRenderViewEntity().posZ);
        if (RenderUtil.camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtil.mc.getRenderManager().viewerPosX, bb.minY + RenderUtil.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtil.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtil.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtil.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtil.mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
    ...
    @Contract(pure = true)
    public static void drawText(@NotNull final AxisAlignedBB bb, @NotNull final String text) {
        GlStateManager.pushMatrix();
        glBillboardDistanceScaled((float)((bb.maxX - bb.minX) / 2.0 + bb.minX), (float)((bb.maxY - bb.minY) / 2.0 + bb.minY), (float)((bb.maxZ - bb.minZ) / 2.0 + bb.minZ), (EntityPlayer)RenderUtil.mc.player, 1.0f);
        GlStateManager.disableDepth();
