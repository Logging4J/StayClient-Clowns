...
public class Setting<T>
{
    ...
    private boolean hasLimiter;
    private Function1<T, T> limiter;
    
    public Setting(final String name, final T defaultValue) {
        this.hasLimiter = false;
        this.limiter = (kotlin.jvm.functions.Function1<T, T>)(t -> t);
        this.name = name;
    ...
    public void setValue(final T value) {
        ...
        final ClientChangeEvent.SettingChange<T> settingChange = (ClientChangeEvent.SettingChange<T>)new ClientChangeEvent.SettingChange(this);
        settingChange.post();
        ...
        if (this.hasLimiter) {
            this.value = (T)this.limiter.invoke((Object)this.value);
        }
    }
    ...
    public void setLimiter(final Function1<T, T> limiter) {
        this.limiter = limiter;
        this.hasLimiter = true;
    }
