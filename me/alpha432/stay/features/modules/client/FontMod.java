...
public class FontMod extends Module
{
    ...
    public FontMod() {
        ...
        this.antiAlias = (Setting<Boolean>)this.register(new Setting("AntiAlias", (T)Boolean.TRUE, "Smoother font."));
        this.fractionalMetrics = (Setting<Boolean>)this.register(new Setting("Metrics", (T)Boolean.TRUE, "Thinner font."));
        this.customAll = (Setting<Boolean>)this.register(new Setting("CustomAll", (T)Boolean.TRUE, "Renders font everywhere"));
